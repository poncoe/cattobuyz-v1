...
export default {
  ...
  */
  head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: 'Cattobuyz' }
    ],
    link: [
  ...
  */
  ...
  axios: {
    baseURL: 'http://localhost/cattobuyz-microservices/public/'   // your lumen project base url
  },
  /*
  ** Build configuration
  ...
  */
  ...
  env: {
    PAYPAL_CLIENT_ID: "Abfe_UmbRe483Puotqvk7J7a-Bwe3Iw4hZig9wI8VIXFVVko4PSJ9lMKj0eglYgFoVynfZwqlkrBRotW" // add your paypal client id
  }
}
